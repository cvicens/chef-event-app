...
const images = {
  ...
  launch_orig: require('../Images/launch-icon.png'),
  launch: require('../Images/the-cook.png'),
  ready: require('../Images/your-app.png'),
  ignite: require('../Images/ignite_logo.png'),
  igniteClear: require('../Images/ignite-logo-transparent.png'),
  tileBg: require('../Images/tile_bg.png'),
  background: require('../Images/kitchen-red-brown.png'),
  //background: require('../Images/kitchen-up-maroon.png'),
  //background: require('../Images/kitchen-dark-pink.png'),
  //background: require('../Images/kitchen-blue.png'),
